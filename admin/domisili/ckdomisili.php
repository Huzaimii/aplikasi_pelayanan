...
$pdf->Setfont("Arial", "B", "13");
	$pdf->cell(20,0.7,'SURAT KETERANGAN DOMISILI',0,1,'C');

	$pdf->Setfont("Arial", "", "10");
	$pdf->cell(20,0.27,'NOMOR :' .$data['id_domisili']. '/DOM/2023',0,1,'C');
...
$pdf->Cell(1, 0, '', 0, 0, '');
 ...
 $pdf->Cell(5, 0, 'Status Perkawinan', 0, 0, '');
	...
	$pdf->Cell(5, 0.4, 'Dengan ini menerangkan bahwa benar yang bersangkutan berdomisili di desa Tanah Abang', 3, 1, '');
