...
$pdf->Setfont("Arial", "B", "13");
	$pdf->cell(20,0.7,'PERMOHONAN IZIN KERAMAIAN',0,1,'C');

	$pdf->Setfont("Arial", "", "10");
	$pdf->cell(20,0.27,'NOMOR :' .$data['id_keramaian']. '/KRM/2023',0,1,'C');
...
$pdf->Cell(1, 0, '', 0, 0, '');
 ...
 $pdf->Cell(5, 1, 'Alamat', 0, 0, '');
	...
	$pdf->Cell(1, 0, '', 0, 0, '');
	$pdf->Cell(5, 0.4, 'Memohon ijin keramaian yang akan kami laksanakan pada :', 3, 1, '');
$pdf->Cell(1, 0, '', 0, 0, '');
	$pdf->Cell(5, 1, 'Hari/Tanggal', 0, 0, '');
	$pdf->Cell(2, 1, ': '.$data['hari_tanggal'].'', 0, 1, '');
	$pdf->Cell(1, 0, '', 0, 0, '');
	$pdf->Cell(5, 0, 'Waktu', 0, 0, '');
	$pdf->Cell(2, 0, ': '.$data['waktu'].'', 0, 1, '');
	$pdf->Cell(1, 0, '', 0, 0, '');


	$pdf->Cell(5, 1, 'Tempat', 0, 0, '');
	$pdf->Cell(2, 1, ': '.$data['tempat_keramaian'].'', 0, 1, '');
	$pdf->Cell(1, 0, '', 0, 0, '');
	$pdf->Cell(5, 0, 'Acara', 0, 0, '');
	$pdf->Cell(2, 0, ': '.$data['hiburan'].'', 0, 1, '');
	$pdf->Cell(1, 0, '', 0, 0, '');
 $pdf->Cell(5, 1, 'Lama Acara', 0, 0, '');
	$pdf->Cell(2, 1, ': '.$data['lama_acara'].'', 0, 1, '');
	$pdf->Cell(1, 0, '', 0, 0, '');
	$pdf->ln(0.9);
	...
	$pdf->Cell(5, 0.0, 'Surat keterangan ini dibuat dan diberikan untuk mendapatkan izin dari Kapolsek Mataraman,', 3, 1, '');
	$pdf->Cell(5, 1.7, 'Demikian surat keterangan ini dibuat,atas perhatiannya dan kerja samanya,kami sampaikan terima kasih.', 0, 1, '');
