					...
					<div class="ps-3">
						<nav aria-label="breadcrumb">
							<ol class="breadcrumb mb-0 p-0">
								...
								<li class="breadcrumb-item active" aria-current="page">Data Belum Bekerja</li>
							</ol>
						</nav>
					</div>
						...
						<div class="card border-top border-0 border-4 border-info">	
							<div class="card-body">
								<div class="border p-4 rounded">
									...
									<hr/>
                                    <form method="POST" action="bekerja/proses.php" enctype="multipart/form-data">
									 ...
									 <div class="form-group mb-4">
                                       ...
                                       <br>
                                        <div class="form-group mb-4">
                                         ...
                                         <div class="form-group mb-4">
                                            <label for="inputAddress">Pekerjaan Sekarang</label>
                                            <input type="text"  name="pekerjaan_skg" class="form-control" id="" placeholder="">
                                        </div>  
                                         <div class="form-group mb-4">
