...
include '../conf/koneksi.php';
  ...
  $id_pekerjaan = $_GET ['id_pekerjaan'];
                 $sql = mysqli_query($koneksi,"SELECT * FROM t_pekerjaan
...
$pdf->SetTitle('Surat Tidak Memili Pekerjaan');
...
$pdf->Setfont("Arial", "B", "13");
	$pdf->cell(20,0.7,'SURAT KETERANGAN BELUM BEKERJA',0,1,'C');

	$pdf->Setfont("Arial", "", "10");
	$pdf->cell(20,0.27,'NOMOR :' .$data['id_pekerjaan']. '/PKJN/2023',0,1,'C');
...
$pdf->Cell(1, 0, '', 0, 0, '');
 ...
 $pdf->Cell(5, 0, 'Status Perkawinan', 0, 0, '');
	...
	$pdf->Cell(5, 0.4, 'Dengan ini menerangkan bahwa benar yang bersangkutan saat ini tidak memiliki pekerjaan', 3, 1, '');
	$pdf->Cell(5, 1, 'Surat Keterangan ini di dibuat untuk '.$data['keperluan']. '.', 3, 1, '');
