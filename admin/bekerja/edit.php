					...
					<div class="ps-3">
						<nav aria-label="breadcrumb">
							<ol class="breadcrumb mb-0 p-0">
								...
								<li class="breadcrumb-item active" aria-current="page">Tidak Bekerja</li>
							</ol>
						</nav>
					</div>
					 <?php 
                    $id_pekerjaan = $_POST['id_pekerjaan'];
                    $sql = mysqli_query($koneksi,"SELECT * FROM t_pekerjaan WHERE id_pekerjaan='$id_pekerjaan'");
				...
				<div class="row">
						...
						<div class="card border-top border-0 border-4 border-info">
							<div class="card-body">
								<div class="border p-4 rounded">
									...
									<hr/>
                                    <form method="POST" action="bekerja/proses.php">
										...
										<div class="row mb-3">
										<label for="inputEnterYourName" class="col-sm-3 col-form-label">Pekerjaan Sekarang</label>
										<div class="col-sm-9">
											<input type="text" class="form-control" id="inputEnterYourName" name="pekerjaan_skg" value="<?=$data['pekerjaan_skg']; ?>">
										</div>
										</div>
                  ...
                  <div class="form-group">
                    ...
                    <br>
									...
									<div class="row mb-3">
										<div class="col-sm-9">
											<input type="hidden" class="form-control" id="inputEnterYourName" name="id_pekerjaan" value="<?=$data['id_pekerjaan']; ?>">
										</div>
									</div>
									<div class="row">
