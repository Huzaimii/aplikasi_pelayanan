	<div class="page-wrapper">
			<div class="page-content">
				...
				<div class="page-breadcrumb d-none d-sm-flex align-items-center mb-3">
                    ...
                    $sql = mysqli_query($koneksi,"SELECT * FROM t_domisili WHERE id_domisili='$id_domisili'");
				...
				<div class="row">
                  ...
                  <div class="form-group">
                    ...
                    <br>
									...
									<div class="row mb-3">
										<div class="col-sm-9">
											<input type="hidden" class="form-control" id="inputEnterYourName" name="id_domisili" value="<?=$data['id_domisili']; ?>">
										</div>
									</div>
